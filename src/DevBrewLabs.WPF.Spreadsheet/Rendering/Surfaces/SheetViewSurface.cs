...
namespace DevBrewLabs.WPF.Spreadsheet.Rendering
{
    ...
    /// </summary>
    internal abstract class SheetViewSurface : Canvas
    {
        private InteractionLayer _interactionLayer;

        public SheetView SheetView { get; private set; }

        public SheetViewSurface()
        {
            SnapsToDevicePixels = true;
        }

        public virtual void AttachSheet(SheetView sheetView)
        {
            SheetView = sheetView;
        }
        ...
        /// </summary>
        /// <param name="dc"></param>
        protected abstract SpreadHitTestResult HitTestCore(SheetView sheetView, Point hitPoint);
    }
}
